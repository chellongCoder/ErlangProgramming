...
quicksort([Pivot|Rest]) ->
  {Smaller, Larger} = partition(Pivot,Rest,[],[]), %%partition : chuyển các phần tử nhỏ hơn PIVOT qua bên trái , chuyển các phần tử lớn hơn PIVOT sang bên phải, lấy PIVOT làm trục.
